...
echo "<pre>SETUP BY Fadhil | Fadhil.cf</pre>" > /home/vps/public_html/index.html
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/ccpbcrawler/autoscript/master/conf/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.github.com/thekillers123/autoscript/master/conf/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.github.com/ccpbcrawler/autoscript/master/conf/1194-client.conf"
...
# info
clear
echo "VPS Auto installation Script" | tee log-install.txt
...
echo "Password : $dummy"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
