...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/arieonline/autoscript/master/conf/1194.conf"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/arieonline/autoscript/master/conf/1194-client.conf"
...
echo ""  | tee -a log-install.txt
echo "fungsi lain lain"  | tee -a log-install.txt
echo "----------"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "Auto Script Installer Vps - @CrEatiNgDummY"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
