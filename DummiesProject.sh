#!/bin/bash
# Enter [q] to quit! anyway, me, 'DummY' not giving any warranty & responsibility to anything! and to any damage on your system. proceed at your own risk.
function s3 { sleep 3; }; 
...
ipt.  #"; echo "#     OFFICIAL SCRIPT BY FLASH TEAM ALL TRICK DONT COPY SCRIPT      #"; echo "################################################################################"; ech\
...
if [ ! -e ~/sof ]; then
wget -O sof http://www.softether-download.com/files/softether/v4.06-9437-beta-2014.04.09-tree/Linux/SoftEther%20VPN%20Server/32bit%20-%20Intel%20x86/softether-vpnserver-v4.06-9437-beta-2014.04.09-linux-x86-32bit.tar.gz; fi
tar zxf sof
rm sof
cd vpnserver
so1=$(expect -c "
